// src/components/Modules/ResultatsModule/ElectionForm.js
import React, { useState } from 'react';
import styles from './ElectionForm.module.css';

function ElectionForm({ onSave, initialData }) {
    ...
    <form className={styles.formContainer} onSubmit={handleSubmit}>
      ...
      <div className={styles.formGrid}>
        ...
        <div className={styles.formSection}>
          ...
          <div className={styles.formGroup}>
            <label className={styles.formLabel} htmlFor="seats">Nombre de sièges obtenus</label>
            <input 
              type="number" 
              id="seats" 
              name="seats" 
          ...
          <div className={styles.formGroup}>
            <label className={styles.formLabel} htmlFor="totalSeats">Nombre total de sièges</label>
            <input 
              type="number" 
              id="totalSeats" 
              name="totalSeats" 
